...
namespace SistemaPadronElectoral.Controllers
{
    ...
    public class PersonaVotantesController : ControllerBase
    {
        ...
        public IActionResult DebugRoles()
        {
            ...
            {
                Claims = claims,
                EstaEnRol = User.IsInRole("AdministradorPadronElectoral")
            });
        }



        [Authorize(Roles = "AdministradorPadronElectoral")]
        [HttpGet("solo-admin-padron")]
        public IActionResult SoloAdmin()
        {
            return Ok(" Acceso autorizado para AdministradorPadronElectoral");
        }


        // GET: api/PersonaVotantes
        [Authorize(Roles = "AdministradorPadronElectoral,AdministradorElecciones")]
        [HttpGet]
        ...
        public async Task<ActionResult<PersonaVotante>> GetPersonaVotanteById(Guid id)
        {
            ...
            if (!roles.Contains("AdministradorPadronElectoral"))
            {
                return Forbid();
            }
        ...
        public async Task<ActionResult<PersonaVotante>> PostPersonaVotante([FromForm] DtoPersonaVotante personaVotanteDto)
        {
            ...
            var personaVotante = new PersonaVotante
            {
                ...
                Nombres = personaVotanteDto.Nombres,
                Apellidos=personaVotanteDto.Apellidos,
                Direccion = personaVotanteDto.Direccion,
                idRecinto = personaVotanteDto.idRecinto,
        ...
        public async Task<IActionResult> PutPersonaVotante(int ci, [FromForm] DtoPersonaVotante personaVotanteDto)
        {
            ...
            personaVotante.Nombres = personaVotanteDto.Nombres;
            personaVotante.Apellidos = personaVotanteDto.Apellidos;

            personaVotante.Direccion = personaVotanteDto.Direccion;
            personaVotante.idRecinto = personaVotanteDto.idRecinto;
